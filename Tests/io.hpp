...
#define IO_H
  ...
  static inline long writeBasicParameters(FILE *outfile,const char *file_path,const char *write_mode,config::algorithm rounds[],int iteration,int number_of_rounds,long ptr_position);
  ...
  static inline long readSLMMParameters(FILE *infile,const char *file_path,const char *read_mode,config::slmm slmm_parameters[],int iteration,int number_of_rounds,long ptr_position);
  static inline long readBasicParameters(FILE *infile,const char *file_path,const char *read_mode,config::algorithm rounds[],int iteration,int number_of_rounds,long ptr_position);
...
static inline long writeLMParameters(FILE *outfile,const char *file_path,const char *write_mode,config::lm lm_parameters[],int iteration,int number_of_rounds,long ptr_position)
  ...
  static inline long writeBasicParameters(FILE *outfile,const char *file_path,const char *write_mode,config::algorithm rounds[],int iteration,int number_of_rounds,long ptr_position)
  {
    ...
    size_t size = sizeof(rounds[0]) * number_of_rounds;
    fwrite_status = fwrite(rounds,size,1,outfile);
    //Update pointer position after writing
    pointer_position = ftell(outfile);
  ...
  static inline long readBasicParameters(FILE *infile,const char *file_path,const char *read_mode,config::algorithm rounds[],int iteration,int number_of_rounds,long ptr_position)
  {
    ...
    size_t size = number_of_rounds * sizeof(rounds[0]);
    fread_status = fread(rounds,size,1,infile);
    //Update pointer position after reading
    pointer_position = ftell(infile);
