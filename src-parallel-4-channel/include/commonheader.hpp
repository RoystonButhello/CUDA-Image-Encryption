...
namespace common
{
  ...
  static inline void initializeMapParameters(config::mt mt_parameters[],int number_of_rounds);
  static inline void assignMapParameters(config::mt mt_parameters[],int number_of_rounds);
  static inline void displayMapParameters(config::mt mt_parameters[],int number_of_rounds);
  ...
  static inline void assignMapParameters(config::mt mt_parameters[],int number_of_rounds)
  {
    ...
    for(int i = 0; i < number_of_rounds; ++i)
    {
      ...
      mt_parameters[i].seed_5 = getRandomInteger(SEED_LOWER_LIMIT,SEED_UPPER_LIMIT);
    } 
  }
  ...
  static inline void displayMapParameters(config::mt mt_parameters[],int number_of_rounds)
  {
    for(int i = 0; i < number_of_rounds; ++i)
    {
      ...
      printf("\nmt_parameters.seed_5 = %d",mt_parameters[i].seed_5);
