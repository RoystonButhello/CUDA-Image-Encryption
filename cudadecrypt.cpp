...
#include "include/cudafunctions.hpp"
...
int main()
{
  ...
  image=imread("images/airplane_cuda_encrypted.png",IMREAD_COLOR);
  ...
  if(DEBUG_IMAGES==1)
  {
     ...
     cv::imwrite("images/airplane_cuda_decrypted.png",img_reshape);
  }
